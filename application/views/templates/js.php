...
<script src="<?php echo $assets;?>/plugins/jquery-1.8.3.min.js" type="text/javascript"></script>
<script src="<?php echo $assets;?>/plugins/bootstrap/js/bootstrap.min.js" type="text/javascript"></script>
<script src="<?php echo $assets;?>/plugins/pace/pace.min.js" type="text/javascript"></script>
